...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getEvents: function getEvents() {
      ...
      var selectedMonth = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
      var getUrl = '/api/events/get';
      if (selectedMonth !== '') getUrl = getUrl + '/' + selectedMonth;
      axios.get(getUrl).then(function (response) {
        _this.monthYear = response.data.month;
        _this.items = response.data.events;
        _this.numMonth = response.data.numerical_month;
  ...
  created: function created() {
    ...
    _app_js__WEBPACK_IMPORTED_MODULE_0__["EventBus"].$on('add-event-successful', function (data) {
      _this2.getEvents(_this2.year + '-' + _this2.numMonth);
    });
    this.getEvents();
  }
});
  ...
  methods: {
    formSubmit: function formSubmit(e) {
      ...
      axios.post('/api/events/add', {
        ...
        _app_js__WEBPACK_IMPORTED_MODULE_0__["EventBus"].$emit('add-event-successful', 'from form component'); //this.$refs.getEvents(this.year+'-'+this.numMonth);
      });
    }
  }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row" }, [
      _c("form", { on: { submit: _vm.changeMonth } }, [
        _c("div", { staticClass: "form-group row" }, [
          _c("div", { staticClass: "col-sm-4" }, [
            _c("label", { attrs: { for: "name" } }, [_vm._v("Year")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
              ...
              domProps: { value: _vm.yearSelected },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.yearSelected = $event.target.value
                }
              }
            })
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-sm-4" }, [
            _c("label", { attrs: { for: "name" } }, [_vm._v("Month")]),
            _vm._v(" "),
            _c(
              "select",
              {
              ...
              _vm._l(_vm.monthSelect, function(month) {
                return _c(
                  "option",
                  {
                    key: month.num,
                    domProps: {
                      value: month.num,
                      selected: month.num == _vm.numMonth
                    }
                  },
          ...
          _c("div", { staticClass: "card-body" }, [
            _c(
              ...
              _vm._l(_vm.items, function(item) {
                return _c(
                  "tr",
                  { key: item.month, class: { "table-success": item.events } },
                  [
                    _c("td", [_vm._v(_vm._s(item.month))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(item.events))])
                  ]
                )
              }),
              0
      ...
      _c("div", { staticClass: "col-sm-4" }, [
        _c(
          "button",
          {
            ...
            attrs: { type: "submit", id: "btnChange" }
          },
          [_vm._v("ChangeMonth")]
        )
      ])
    ...
    _c("div", { staticClass: "form-group row" }, [
      _c("div", { staticClass: "col-sm-12" }, [
        ...
        _c("input", {
          ...
          staticClass: "form-control",
          attrs: { type: "text", id: "event", name: "event", value: "" },
    ...
    _c("div", { staticClass: "form-group row" }, [
      _c("div", { staticClass: "col-sm-6" }, [
        ...
        _c("input", {
          ...
          staticClass: "form-control",
          attrs: { type: "date", id: "from", name: "from", value: "" },
      ...
      _c("div", { staticClass: "col-sm-6" }, [
        ...
        _c("input", {
          ...
          staticClass: "form-control",
          attrs: { type: "date", id: "to", name: "to", value: "" },
      ...
      _c("div", { staticClass: "col-sm-12" }, [
        _c("div", { staticClass: "custom-control custom-checkbox" }, [
          _c("input", {
            ...
            attrs: { type: "checkbox", id: "Mon", value: "Mon" },
            domProps: {
          ...
          _c(
            "label",
            { staticClass: "custom-control-label", attrs: { for: "Mon" } },
            [_vm._v("Mon")]
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "custom-control custom-checkbox" }, [
          _c("input", {
            ...
            staticClass: "custom-control-input",
            attrs: { type: "checkbox", id: "Tue", value: "Tue" },
            domProps: {
              checked: Array.isArray(_vm.days)
          ...
          _c(
            "label",
            { staticClass: "custom-control-label", attrs: { for: "Tue" } },
            [_vm._v("Tue")]
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "custom-control custom-checkbox" }, [
          _c("input", {
            ...
            staticClass: "custom-control-input",
            attrs: { type: "checkbox", id: "Wed", value: "Wed" },
            domProps: {
              checked: Array.isArray(_vm.days)
          ...
          _c(
            "label",
            { staticClass: "custom-control-label", attrs: { for: "Wed" } },
            [_vm._v("Wed")]
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "custom-control custom-checkbox" }, [
          _c("input", {
            ...
            staticClass: "custom-control-input",
            attrs: { type: "checkbox", id: "Thu", value: "Thu" },
            domProps: {
              checked: Array.isArray(_vm.days)
          ...
          _c(
            "label",
            { staticClass: "custom-control-label", attrs: { for: "Thu" } },
            [_vm._v("Thu")]
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "custom-control custom-checkbox" }, [
          _c("input", {
            ...
            staticClass: "custom-control-input",
            attrs: { type: "checkbox", id: "Fri", value: "Fri" },
            domProps: {
              checked: Array.isArray(_vm.days)
          ...
          _c(
            "label",
            { staticClass: "custom-control-label", attrs: { for: "Fri" } },
            [_vm._v("Fri")]
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "custom-control custom-checkbox" }, [
          _c("input", {
            ...
            staticClass: "custom-control-input",
            attrs: { type: "checkbox", id: "Sat", value: "Sat" },
            domProps: {
              checked: Array.isArray(_vm.days)
          ...
          _c(
            "label",
            { staticClass: "custom-control-label", attrs: { for: "Sat" } },
            [_vm._v("Sat")]
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "custom-control custom-checkbox" }, [
          _c("input", {
            ...
            staticClass: "custom-control-input",
            attrs: { type: "checkbox", id: "Sun", value: "Sun" },
            domProps: {
              checked: Array.isArray(_vm.days)
          ...
          _c(
            "label",
            { staticClass: "custom-control-label", attrs: { for: "Sun" } },
            [_vm._v("Sun")]
          )
        ])
      ])
...
__webpack_require__(/*! C:\Users\Karlo\laravel-workspace\laravel-7-example\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Karlo\laravel-workspace\laravel-7-example\resources\sass\app.scss */"./resources/sass/app.scss");
